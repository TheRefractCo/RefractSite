Create your own member cards.
- do absolutely anything you'd like, but keep it in the frame.
- code it in the ___Card.svelte file and keep styles and scripts in the same file.
